...
| Crash logs | No | Required/automatic when a reportable failure occurs | No | Analytics; App functionality | LIA production error reports may contain sanitized stack, route path, platform, version and authenticated UID. |
