...
export function CustomerPageSkeleton({ variant }: CustomerPageSkeletonProps) {
  if (variant === "home") {
    return (
      <main className="min-h-screen animate-pulse bg-gray-50 pb-28">
        <HeaderSkeleton />
  ...
  if (variant === "cart") {
    return (
      <main className="min-h-screen animate-pulse bg-gray-50 pb-48">
        <HeaderSkeleton />
        ...
        <div className="fixed inset-x-0 bottom-0 border-t border-gray-200 bg-gray-50/95 p-4 backdrop-blur-xl"><div className="mx-auto max-w-2xl space-y-3"><Block className="h-4 w-full" /><Block className="h-12 w-full" /></div></div>
      </main>
    );
  }
  ...
  if (variant === "product") {
    return <main className="min-h-screen animate-pulse bg-gray-50 pb-28"><Block className="aspect-square w-full rounded-none" /><div className="mx-auto max-w-2xl space-y-4 px-4 py-5"><Block className="h-7 w-3/4" /><Block className="h-6 w-1/4" /><Block className="h-20 w-full" /><ProductGrid /></div></main>;
  }

  if (variant === "order-detail") {
    return <main className="min-h-screen animate-pulse bg-gray-50 pb-8"><HeaderSkeleton /><div className="mx-auto max-w-lg space-y-4 px-4 py-4">{Array.from({ length: 5 }, (_, index) => <div key={index} className="space-y-3 rounded-2xl border border-gray-100 bg-white/70 p-5"><Block className="h-5 w-2/5" /><Block className="h-4 w-full" /><Block className="h-4 w-4/5" /></div>)}</div></main>;
  }

  if (variant === "store-info") {
    return <main className="min-h-screen animate-pulse bg-gray-50 pb-8"><HeaderSkeleton /><Block className="h-64 w-full rounded-none" /><div className="space-y-4 p-4">{Array.from({ length: 3 }, (_, index) => <div key={index} className="space-y-3 rounded-2xl bg-white/70 p-5"><Block className="h-5 w-1/3" /><Block className="h-4 w-full" /><Block className="h-4 w-3/4" /></div>)}</div></main>;
  }
