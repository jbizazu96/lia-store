...
export function AccountDeletionReviewWorkspace({
  ...
  const loadList = async () => {
    ...
    setError("");
    try {
      const result = await adminWorkspaceClientService.getAccountDeletionRequests(status);
