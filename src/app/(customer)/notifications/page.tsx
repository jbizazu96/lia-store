    ...
    <main className="min-h-screen bg-white">
      ...
      <div className="sticky top-0 z-20 bg-white/95 backdrop-blur-xl">
        <div className="relative flex items-center gap-3 px-4 py-4 max-w-2xl mx-auto">
          ...
          <h1 className="pointer-events-none absolute inset-x-16 text-center text-xl font-bold text-gray-800">Notifications</h1>
        ...
        {notifications.length > 0 && (
          <div className="mb-3 flex justify-end">
            <button
              ...
              disabled={clearing}
              className="rounded-xl border border-red-100 bg-red-50 px-3 py-2 text-xs font-bold text-red-600 transition hover:bg-red-100 disabled:opacity-50"
            >
